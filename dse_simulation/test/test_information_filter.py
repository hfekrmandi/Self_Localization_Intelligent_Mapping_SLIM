...
class TestInformationFilterValid(TestInformationFilterCommon):
    ...
    def test_to_frame_4(self):
        ...
        rospy.loginfo("-D- test_from_frame_1")
        agent1_global = np.array([[0], [0], [0]])
        agent2_global = np.array([[0.4], [-0.6], [5*np.pi/4]])
        agent2_in_frame_agent1_true = np.array([[0.4], [-0.6], [5*np.pi/4]])
        agent1_in_frame_agent2_true = np.array([[0.5*np.sqrt(2)], [-0.1*np.sqrt(2)], [3*np.pi/4]])
    ...
    def test_to_frame_5(self):
        ##############################################################################
        rospy.loginfo("-D- test_from_frame_1")
        agent1_global = np.array([[1], [1], [7/4.0*np.pi]])
        agent2_global = np.array([[0.4], [-0.6], [135*np.pi/180]])
        agent2_in_frame_agent1_true = np.array([[1.1*np.sqrt(2)], [0.5*np.sqrt(2)], [3/2.0*np.pi]])
        agent1_in_frame_agent2_true = np.array([[0.5*np.sqrt(2)], [-1.1*np.sqrt(2)], [np.pi/2]])
    ...
    def test_from_to_from_frame_1(self):
        ##############################################################################
        rospy.loginfo("-D- test_from_frame_1")
        agent1_global = np.array([[0], [0], [np.pi/2]])
        agent2_global = np.array([[0], [1], [-np.pi/2]])
        agent2_in_frame_agent1_true = np.array([[1], [0], [0]])
        agent1_in_frame_agent2_true = np.array([[-1], [0], [0]])
